    ...
    return (
        <div className='background'>
            <Carousel items={[ 
                ...
                <CarouselItem title='Github Finder' tags={['JavaScript', 'React', 'Redux', 'Materialize']} description='A full-stack application built using React, Redux, and Express.' link='https://githubfinder901237.netlify.app'/>,
